...
import { Location, Position, Range, TextDocument, Uri, workspace, WorkspaceConfiguration } from "vscode";
...
import { getCfScriptRanges, getClosingPosition, isCfcFile } from "../utils/contextUtil";
...
import { Component, COMPONENT_EXT, getApplicationUri, getServerUri } from "./component";
...
import { getCfScriptTagPatternIgnoreBody, getCfStartTagPattern, getTagPattern, OutputVariableTags, parseStartTags, parseTags, StartTag, Tag, VariableAttribute } from "./tag";
import { Argument, functionValuePattern, getLocalVariables, isUserFunctionVariable, parseScriptFunctionArgs, UserFunction, UserFunctionSignature, UserFunctionVariable } from "./userFunction";
