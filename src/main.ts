...
import BoxReferenceProvider from "./features/referenceProvider";
...
export function activate(context: ExtensionContext): void {
    ...
    context.subscriptions.push(languages.registerReferenceProvider(DOCUMENT_SELECTOR, new BoxReferenceProvider()));
