import { CancellationToken, Definition, Location, Position, Range, TextDocument, TypeDefinitionProvider, WorkspaceConfiguration, workspace } from "vscode";
...
import { Argument, UserFunction, UserFunctionSignature, getFunctionFromPrefix, getLocalVariables } from "../entities/userFunction";
import { Variable, getApplicationVariables, getServerVariables, parseVariableAssignments } from "../entities/variable";
